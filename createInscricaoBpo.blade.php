                ...
                <form id="meuFormulario" action="{{ route('inscricao.store') }}" method="POST">
                    ...
                    <div x-show="passo === 1" x-transition>
                        ...
                        <div class="grid-form">
                            ...
                            <div class="col-4 input-container" style="position: relative">
                                <input 
                                type="text" 
                                name="cpf"  
                                id="id_cpf" 
                            ...
                            <div class="col-6 radio-group-container" :class="{ 'campo-obrigatorio': tentouAvancar && sexo === '' }">
                    ...
                    <div x-show="passo === 2" x-cloak x-transition>
                        ...
                        <div class="grid-form">
                            ...
                            <div class="habilidades-section col-12"
